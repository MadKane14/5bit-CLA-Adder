...
HD_PWD='D:/VLSI_Design M-25 Sem3/Course Project/Verilog/FPGA_CLA/FPGA_CLA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CLA_5bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CLA_5bit.tcl
