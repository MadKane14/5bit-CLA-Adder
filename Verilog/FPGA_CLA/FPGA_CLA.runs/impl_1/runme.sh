...
HD_PWD='D:/VLSI_Design M-25 Sem3/Course Project/Verilog/FPGA_CLA/FPGA_CLA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CLA_5bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CLA_5bit.tcl -notrace
